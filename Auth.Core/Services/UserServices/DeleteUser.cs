...
namespace Auth.Core.Services.UserService
{
    ...
    public class DeleteUser : ServiceBase<DeleteUserRequest, DeleteUserResponse>
    {
        ...
        protected override async Task<DeleteUserResponse> PerformAction(DeleteUserRequest requestObject)
        {
            ...
            try
            {
                ...
                var id = await UserRepository.DeleteUser(new { Id = requestObject.Id }, connectionString);
